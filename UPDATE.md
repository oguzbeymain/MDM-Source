...
| `MDM.exe` | Main download manager (no self-update) |

## Flow

1. User starts `MDM.exe` (or `MDM.Updater.exe`).
...
4. If newer: downloads zip, replaces files, starts `MDM.exe --from-updater`.
